...
public class TestTweetAPIClient {
    ...
    public void testUserCanSearchProfileSuccessfully() {
        Response response = (Response) tweetAPIClient.searchProfile("asif605");
    ...
    public void testUser2CanSearchProfileSuccessfully() {
        Response response = (Response) tweetAPIClient.searchProfile("asif1234");
        response.getBody().prettyPrint();
        int statusCode = response.getStatusCode();
        String statusLine = response.getStatusLine();
        Assert.assertEquals(statusCode, 200);
    ...
    public void testUserCanAgainDoTweetSuccessfully() {
        Response response = (Response) tweetAPIClient.sentTweet("Tweeting from Long Island, Deer Park");
        response.getBody().prettyPrint();
        int statusCode = response.getStatusCode();
        String statusLine = response.getStatusLine();
        Assert.assertEquals(statusCode, 200);
    ...
    public void testUserCannnotTweetDuplicateTweet() {
        Response response = (Response) tweetAPIClient.sentTweet("This is Asif" + UUID.randomUUID());
        response.getBody().prettyPrint();
        int statusCode = response.getStatusCode();
        String statusLine = response.getStatusLine();
        Assert.assertEquals(statusCode, 200);
...
//        System.out.println();
    ...
    public void test_Case_Get(){
        given().
                ...
                body("data.first_name",hasItems("Mike","Lindsay"));
    }
    @Test(enabled = false)
...
*/
    ...
    public void postTweets(){
        ...
        Response response = request.post("http://localhost:307/posts");
        int code = response.getStatusCode();
    ...
    public void deleteTweet(){
        RequestSpecification request = RestAssured.given();
        Response response = request.delete("http://localhost:107/posts/100");
        int code = response.getStatusCode();
        Assert.assertEquals(code,200);
    }
    @Test
